      ...
      <div onmouseover="handleClick(event)" class="navmenu">
          ...
          <div class="navtwo navtwo-menu">
              <ul>
                  ...
                  <li class="navtwo-student"><a href="" style="padding-left:10px">Student Corner</a>
                      <ul class="navtwo-dropdown">
                          <li style="padding-top:20px"><a href="" style="padding-left:10px">Student Corner</a></li>
                          <li><a href="" style="padding-left:10px">Student Corner</a></li>
                          <li><a href="" style="padding-left:10px">Student Corner</a></li>
                      </ul>
                  </li>
                  <li class="navtwo-about"><a href="" style="margin-left:9px">About</a>
                      <ul class="navtwo-dropdown-one">
                          <li style="padding-top:20px"><a href="">About1</a></li>
